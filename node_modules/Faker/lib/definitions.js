...
exports.stupid_occupation = function(){return['New brand of cola','Monorail company','triangular and circular houses','interchangeable shoes','internet cafe','pens that never from out of ink','new type of fuel','hovercars','new internet service provider','college/cheerleader calendars','college/male athlete calendars','voice-activated radio/TV','voice activated hourse','remote control finder','voice activated keys','hydrogen powered cars','easy wrinkle remover','never-ending bottle of soda','underwear with pockets','new clothing line','donut store','shoe pockets','wireless TV headseats','haircoloring shampoo','desks with build in computers','text books on computers','automatic dog food dispenser','remote control lawnmower','washer-dryer all in one combo','color eye drops','mechanical spiders','MP3 player watch','watch that automatically knows what time zone it’s in','butt-wiping toilets','better toothpaste','virus protection','toothbrush with toothpaste in it','video phone','logo changing shirt','solar color changing shirt','solar powered sports cars','color changing nail polish','TV on cell phones','personal soda dispenser','voice-controlled air conditioning system','resort','color changing hair bow','voice activated elevators','phone/tv/radio in a shower','sponges with built in soap','self-moving furniture','multi-colored markets','reversible backpacks','student tracker system','remote to control of your appliances','sneakers with comfortable insides','auto food/water dispenser for animals for when family is away for a few days','vacuum with perfume in it','trash can with perfume in it','real-looking pony tail that hooks in your hair','3 in 1 paint color can','refrigerator that has an alarm for bad food','cat food dispenser','boats that give a smooth ride','underwater restaurant','spa franchise','foldable hammock for car trunks','high quality light fixtures','health bar chain','comfy',' damage-free ear phones','chair with popcorn holder',' tray',' built-in radio','elbow massager','self-cleaning microwave','security software to protect against hackers and credit card scams','wholesale store without membership card','aerobic center for teenagers','chair store w/ imported European chocolate','restaurants for dogs and cats','oxygen tanks so dogs and cats can go diving','computer animation company','real estate company','cosmetics/hair care company','bowling alley in Cartagena','Store that makes custom clothes','electronic translator that you put in your ear','fashion design company for new designers that need a start','iron rod production','selling traditional jewelry','brail screen that reads computer and translates the text on a computer into 3D brail that the blind could read','lumber company','Make a ski board rotating wardrobe at ski resorts','flavored straws','A grocery store that also had a fitness center','a diagonal load dishwasher','sushi restaurant','Candyland theme park chain','web design/advertising company','per month CD online company','educational software for the visually impaired','bringing broadband internet access into developing countries','Sonar for blind people','voice/data equipment for hospitals','drink machine that talks to you', 'organic cat food'];};
